...
const enhancePhoto = async (req, res) => {
  ...
  try {
    ...
    // ── 3. Read the upload as a stream and hand it to Replicate.
    //     The replicate-javascript SDK accepts a ReadableStream/Buffer
    //     directly for file-type inputs and handles the upload for us —
    //     no need to manually base64-encode or host the file ourselves.
